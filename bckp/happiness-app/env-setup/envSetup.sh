...
if echo ${versions[@]} | grep -q -w ${CODENAME}; then
    echo "Installing Hyperledger Fabric prereqs for Ubuntu ${CODENAME}"
else
...
# Install goLang
echo "# Installing golang version 1.12.9, y/n?"
read input
if [ $input = "y" ];
then
    ...
    echo "please type the version you want to install"
        read version
